...
function HeroSection() {
  ...
  const heroImages = [
    ...
    'https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?w=1920',
  ];
    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['EQUIPPING', 'HEALTHCARE', 'EXCELLENCE.'].map((word, i) => (
            <motion.div
              key={word}
              initial={{ y: '100%' }}
              animate={{ y: 0 }}
        ...
        >
          From operating theatres to rural clinics, we supply the medical equipment, diagnostic devices, and consumables that Zimbabwe's healthcare professionals depend on.
        </motion.p>
      ...
      <div className="hidden lg:flex absolute right-8 top-1/2 -translate-y-1/2 z-20">
        ...
        >
          Intermed Medical &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['SURGICAL', 'DIAGNOSTICS', 'LABORATORY', 'HOSPITAL BEDS', 'PPE', 'PHARMA', 'IMAGING', 'STERILIZATION', 'CONSUMABLES'];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              A DECADE OF<br />
              HEALTHCARE<br />
              <span className="text-gold-500">PARTNERSHIP.</span>
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg">
              Intermed Medical Supplies was founded with a clear purpose: to bridge the gap between
              world-class medical technology and Zimbabwe's healthcare facilities. We saw that access
              to quality equipment was a critical barrier to better patient outcomes.
            </p>
            <p className="text-white/40 text-sm leading-relaxed max-w-lg">
              Starting with surgical instruments and consumables, we rapidly expanded into diagnostics,
              laboratory equipment, hospital furniture, and PPE. Today, we serve over 500 healthcare
              facilities across Zimbabwe, from major hospitals to rural clinics. Every product meets
              international standards because patient safety is non-negotiable.
            </p>
            ...
            <div className="flex gap-8 sm:gap-12">
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">2015</div>
              ...
              <div>
                ...
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Product Lines</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Surgical theatre equipment"
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            ...
            >
              WHAT WE <span className="text-gold-500">SUPPLY</span>
            </h2>
            <Link
              to="/services"
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-10 sm:mb-14">
        ...
        >
          <div>
            ...
            >
              FACILITIES <span className="text-gold-500">EQUIPPED</span>
            </h2>
          </div>
          <Link
            to="/projects"
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-44 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          src="https://images.unsplash.com/photo-1516549655169-df83a0774514?w=1920"
          alt="Medical facility operating theatre"
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          <h2 className="font-heading font-bold text-white leading-[0.88] mb-8" style={{ fontSize: 'clamp(2.2rem, 7vw, 4.5rem)' }}>
            READY TO EQUIP<br />
            <span className="text-gold-500">YOUR FACILITY?</span>
          </h2>

          <p className="text-white/50 text-sm sm:text-base lg:text-lg max-w-lg mx-auto mb-10 leading-relaxed">
            Whether you are setting up a new clinic, upgrading a hospital ward, or stocking a laboratory,
            we have the equipment, expertise, and support you need. Request a quote today.
          </p>
